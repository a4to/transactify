...
module.exports = async (req, res) => {
  ...
  const PAYFAST_MERCHANT_ID = config.providers.payfast.publicKey;
  const PAYFAST_MERCHANT_KEY = config.providers.payfast.secret;
  ...
  await axios.post('https://api.payfast.co.za/eng/process', formData).then(async (response) => {
